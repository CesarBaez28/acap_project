...
/**
 * Edita la información del perfil del usuario mediante una solicitud PUT al servidor.
 *
...
export async function editUserProfile({ userData }) {
  ...
  try {
    // Realiza la solicitud PUT para editar la información del perfil de usuario
